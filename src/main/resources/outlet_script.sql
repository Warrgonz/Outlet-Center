...
INSERT INTO outlet_center.usuario (id_usuario, username,password,nombre, apellidos, correo, telefono,ruta_imagen,activo) VALUES 
...
INSERT INTO outlet_center.categoria (id_categoria,descripcion,ruta_imagen,activo) VALUES 
...
INSERT INTO outlet_center.producto (id_producto,id_categoria,descripcion,detalle,precio,existencias,ruta_imagen,activo) VALUES
...
INSERT INTO outlet_center.factura (id_factura,id_usuario,fecha,total,estado) VALUES
...
INSERT INTO outlet_center.venta (id_venta,id_factura,id_producto,precio,cantidad) values
(1,1,5,45000,3),
(2,1,9,15780,2),
(3,1,10,15000,3),
(4,2,5,45000,1),
